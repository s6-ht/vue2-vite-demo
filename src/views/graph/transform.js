  ...
  switch (statement.type) {
    ...
    case 'VariableDeclaration':
      ...
      return {
        ...
        lines: [...initDeclarationLines],
        entryNodes: [...variableDeclarationNode, ...initDeclarationEntryNodes],
    ...
    case 'ReturnStatement':
      ...
      return {
        ...
        exitNodes: [...returnNode, ...returnStatExitNodes],
        breakNodes: [],
        subNodes: [],
      }
    ...
    case 'ThrowStatement':
      // 该节点只能作为进入节点, 不能作为离开节点(因为遇到该节点之后, 直接跳出程序)
      statement.mark = getUuid()
      const throwNode = {
        id: statement.mark,
        name: generate(statement).code,
