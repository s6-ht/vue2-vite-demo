import { ifStatement, switch1, tryCatchStatement } from './sample'

const babelParser = require('@babel/parser')

const fp = require('lodash/fp')

const { transformGeneralAstToGraph } = require('./test')
...
console.log(transformJsAstToGraph(transformJsStringToJsAst(tryCatchStatement)))
export { transformJsStringToMermaidString }
